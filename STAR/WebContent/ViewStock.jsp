					...
					<table align="center" class="table table-bordered"
						...
						<thead>
							<tr>
								...
								<th style="text-align: center;"><h4>Row Label</h4></th>
								<th style="text-align: center;"><h4>Sum Quantity</h4></th>
								<th style="text-align: center;"><h4>Sum Value</h4></th>
		 ...
		 String sql = "select * from stock";
				...
				try{ 
						...
						<tbody>
							...
							<td><%= rs.getString("Row_Labels") %></td>
							<td><%= rs.getString("Sum_Qty") %></td>
							<td><%= rs.getString("Sum_Value") %></td>
