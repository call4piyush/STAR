			...
			<div class="container" style="width: 20%; float: left;">
				...
				<div class="login-card1">
					...
					<ul class="nav nav-pills nav-stacked">
						...
						<li class="active"><a href="CEOLReport.jsp">CEO level
								Report</a></li>
				...
				<div class="tab-content">
					<center>
						<table class="table-responsive table-condensed"
							...
							<tr>
								<td colspan="2" align="center"><h3>CEO level Report</h3></td>
							</tr>
							<tr>
								<td></td>
							</tr>
							<tr>
								<td>Weekly Level FG Coverage Quantity Wise Report</td>
								<td align="center"><a href="#"><input type="button"
										value="View" size="30"></a></td>
							</tr>
							<tr>
								<td>Weekly Level FG Coverage Price Wise Report</td>
								<td align="center"><a href="#"><input type="button"
										value="View"></a></td>
							</tr>
						</table>
